...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    if (!videoURL) {
      if (event.messageReply && event.messageReply.body) {
        ...
        if (foundURLs && foundURLs.length > 0) {
          ...
          api.setMessageReaction("鉂�", event.messageID, () => {}, true);
    ...
    try {
      ...
      api.setMessageReaction("鈴�", event.messageID, () => {}, true);
      ...
      if (response.status === 200 && response.data.download_url) {
        ...
        api.setMessageReaction("鉁�", event.messageID, () => {}, true);
    ...
    if (videoURL) {
      try {
        ...
        if (response.status === 200 && response.data.download_url) {
          ...
          api.setMessageReaction("馃毇", event.messageID, () => {}, true);
        }
      } catch (error) {
        api.setMessageReaction("馃毇", event.messageID, () => {}, true);
      }
